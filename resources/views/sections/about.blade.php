<!-- ═══════════ ABOUT ═══════════ -->
<section id="about"
    class="py-32 px-6 bg-light-surface dark:bg-dark-surface border-y border-light-border dark:border-dark-border transition-colors duration-300 overflow-hidden">
    <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24 items-center">
        ...
        <div class="relative flex justify-center mt-10 md:mt-0">
            <div
                class="absolute inset-0 flex items-center justify-center opacity-50 dark:opacity-20 pointer-events-none">
                <div
                    class="w-[300px] h-[300px] rounded-full border border-zinc-300 dark:border-zinc-600 animate-[spin_20s_linear_infinite]">
                </div>
                <div
                    class="absolute w-[450px] h-[450px] rounded-full border border-zinc-200 dark:border-zinc-700 animate-[spin_30s_linear_infinite_reverse]">
                </div>
            </div>
            <div class="animate-float relative z-10 w-full max-w-sm">
                <div
